...
// Обчислення кількості проєктів в кожній групі бюджету
$budget_groups = array(
    '<500' => 0,
    '500-1000' => 0,
    '1000-5000' => 0,
...
var myChart = new Chart(ctx, { type: 'pie', data: { labels: ['<500', '500-1000', '1000-5000', '>5000'], datasets: [{ backgroundColor: [ '#2ecc71', '#3498db', '#95a5a6', '#9b59b6'], data: [$budget1, $budget2, $budget3, $budget4] }] } }); 
</script>";
